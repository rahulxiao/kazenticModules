...
export default function ApprovedTable({ items }: ApprovedTableProps) {
            ...
            <table className="w-full text-left border-collapse table-fixed">
                <thead>
                    <tr className="bg-[#f2f9fe] text-[#191f38] text-[11px] font-semibold border-b border-gray-200">
                        <th className="px-3 py-2.5 w-[45px] text-center">
                            <input
                                type="checkbox"
                        ...
                        <th className="px-3 py-2.5 w-[200px] text-center">Status</th>
                    </tr>
                </thead>
                <tbody className="">
                    {items.map((item) => (
