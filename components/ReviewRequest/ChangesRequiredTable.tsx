...
export default function ChangesRequiredTable({ items }: ChangesRequiredTableProps) {
    ...
    return (
        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
            <table className="w-full text-left border-collapse table-fixed">
                <thead>
                    <tr className="bg-[#f2f9fe] text-[#191f38] text-[11px] font-normal border-b border-gray-200">
                        ...
                        <th className="px-4 py-2.5 w-[200px] text-center">Status</th>
                    </tr>
                </thead>
                <tbody className="">
                    {items.map((item) => (
                        <tr key={item.id} className="group border-b border-gray-100 last:border-0 hover:bg-gray-50/50 transition-colors">
                            ...
                            <td className="px-4 py-2.5 align-middle">
                                <div className="flex items-center w-full">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <button className="flex items-center gap-1 bg-[#4157fe] hover:bg-[#3b52e0] text-white text-[11px] font-semibold px-3 py-1 rounded-md transition-all shadow-sm">
                            ...
                            <td className="px-2 py-2.5 align-middle text-center">
                                <div className="inline-flex items-center justify-center w-[95px] h-[26px] rounded-lg bg-[#DBE9FF] text-[#191f38] text-[11px] font-semibold">
                                    {item.duration}
                                </div>
                            </td>
                            <td className="px-2 py-2.5 align-middle text-center">
                                <div className="inline-flex items-center justify-center w-[95px] h-[26px] rounded-lg bg-[#ccfbe1] text-[#191f38] text-[11px] font-semibold">
                                    {item.limit}
                                </div>
                            </td>
                            <td className="px-2 py-2.5 align-middle text-center">
                            ...
                            <td className="px-4 py-2.5 align-middle text-center">
                                <div className="inline-flex items-center px-2.5 py-1.5 rounded-lg border border-[#fee6c8] bg-[#FFF9F2] text-[#FF8A00] text-[10px] font-bold gap-2 uppercase tracking-wider">
